...
Further, due to its ease-of-use, PostgreSQL integration, and free self-hosting (provided the organization's revenue is under \$5M), [Directus](https://directus.io/) is highly RECOMMENDED to be used in projects where CMSs are needed.
